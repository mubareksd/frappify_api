...
class Config:
    ...
    SITE_HEALTH_MONITORING_ENABLED = os.getenv("SITE_HEALTH_MONITORING_ENABLED", "True").lower() == "true"
    SITE_HEALTH_CHECK_TIMEOUT_SECONDS = int(os.getenv("SITE_HEALTH_CHECK_TIMEOUT_SECONDS", "8"))
    SITE_HEALTH_CHECK_FRESHNESS_SECONDS = int(os.getenv("SITE_HEALTH_CHECK_FRESHNESS_SECONDS", "300"))
    SITE_HEALTH_CHECK_ON_CREATE = os.getenv("SITE_HEALTH_CHECK_ON_CREATE", "True").lower() == "true"
    SITE_HEALTH_MONITOR_INTERVAL_SECONDS = int(os.getenv("SITE_HEALTH_MONITOR_INTERVAL_SECONDS", "300"))
    SITE_HEALTH_MONITOR_BATCH_SIZE = int(os.getenv("SITE_HEALTH_MONITOR_BATCH_SIZE", "25"))
    SITE_HEALTH_UPTIME_WINDOW_DAYS = int(os.getenv("SITE_HEALTH_UPTIME_WINDOW_DAYS", "90"))
    SITE_HEALTH_RETENTION_DAYS = int(os.getenv("SITE_HEALTH_RETENTION_DAYS", "120"))
...
class TestConfig(Config):
    ...
    SITE_HEALTH_MONITORING_ENABLED = False
